...
A new Flutter beacon plugin.
  ...
  s.dependency 'BeaconCore', '4.0.4'
  s.dependency 'BeaconClientDApp', '4.0.4'
  s.dependency 'BeaconClientWallet', '4.0.4'
  s.dependency 'BeaconBlockchainSubstrate', '4.0.4'
  s.dependency 'BeaconBlockchainTezos', '4.0.4'
  s.dependency 'BeaconTransportP2PMatrix', '4.0.4'
