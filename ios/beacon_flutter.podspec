...
A new Flutter beacon plugin.
  ...
  s.dependency 'BeaconCore', '4.0.1'
  s.dependency 'BeaconClientDApp', '4.0.1'
  s.dependency 'BeaconClientWallet', '4.0.1'
  s.dependency 'BeaconBlockchainSubstrate', '4.0.1'
  s.dependency 'BeaconBlockchainTezos', '4.0.1'
  s.dependency 'BeaconTransportP2PMatrix', '4.0.1'
  s.dependency 'Base58', '~> 4.0.1'
